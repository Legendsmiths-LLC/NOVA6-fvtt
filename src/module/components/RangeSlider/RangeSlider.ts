...
export class RangeSlider extends BaseComponent {
    ...
    static activateListeners(html) {
        html.find(".nova6-js-setting-range-value").on("change", (e) => this._onChangeRangeValue.call(this, e));
        html.find(".nova6-js-setting-range-slider").on("input", (e) => this._onChangeRangeSlider.call(this, e));
    }
